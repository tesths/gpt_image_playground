...
function getIpv4Parts(hostname: string): number[] | null {
...
function assertRelativeProxyPath(path: string): string {
...
function imageAllowItemMatches(url: URL, rawItem: string): boolean {
...
export function createProxyErrorResponse(err: unknown, status = 400): Response {
